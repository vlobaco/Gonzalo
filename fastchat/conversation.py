...
promp_generator = PromptGenerator(knowledge_dir='fastchat/serve/documents', chunk_length=2000, k=3)
    ...
    def get_prompt(self) -> str:
        ...
        if self.sep_style == SeparatorStyle.ADD_COLON_SINGLE:
            ...
            if len(self.messages) > 1:
                #message = self.messages[-2][1]
                #prompt=promp_generator.get_prompt(message)
                prompt=promp_generator.get_prompt(ret)
...
register_conv_template(
    Conversation(
        name="vicuna_v1.1",
        system="Una conversación entre un usuario curiosos y un asistente virtual artificial. " 
        "El asistente da respuestas a la pregunta del usuario que son útiles, detalladas y educadas. ",
